# Fleuris Vault Bank - PPT Reference Script
...
Title: Fleuris Vault Bank
Subtitle: Secure fintech demo - upgraded from an unsafe banking reference
...
## Slide 3 - Meet the Team (with responsibilities)
Title: Meet the Team
Use a 2-column list with name + responsibility.
- Mehak Gupta - Security headers (misconfiguration), documentation and PPT
- Jashanjot Singh - SQL Injection prevention explanation
- Jashan Yadav - Brute force login protection
- Aryan Gupta - CSRF protection in transfers
- Vanshika Sardana - Password hashing and storage safety
- Raghav Verma - Broken access control prevention

## Slide 4 - Vulnerability 1 of 6
Title: Security Misconfiguration (Missing Security Headers)
Assigned member: Mehak Gupta
Key points:
...
Title: SQL Injection
Assigned member: Jashanjot Singh
Key points:
...
Assigned member: Vanshika Sardana
Key points:
...
Title: Thank You
Subtitle: Questions?
Optional footer: Fleuris Vault Bank - Secure fintech demo
